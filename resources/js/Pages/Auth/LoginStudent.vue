...
<template>
    <Head title="دخول الطالب" />
    <div class="auth-page student" dir="rtl">
        ...
        <div class="auth-card">
            ...
            <div class="role-chip"><span class="mi">school</span> بوابة الطالب</div>
            <h1 class="auth-title">أهلاً يا بطل! 🚀</h1>
            <p class="auth-sub">سجّل دخولك وأكمل مغامرة التعلّم</p>

            <form @submit.prevent="submit">
                <div class="field">
                    <label>البريد الإلكتروني</label>
                    <input type="email" v-model="form.email" required autofocus placeholder="example@bare3.sa" />
...
.auth-page { --c:#38BDF8; --c-dark:#0E7490; --c-light:#E0F4FF; --accent:#EC4899;
...
.blob1 { width:380px; height:380px; background:var(--c); opacity:.14; top:-90px; right:-90px; }
.blob2 { width:300px; height:300px; background:var(--accent); opacity:.14; bottom:-80px; left:-80px; }
.blob3 { width:200px; height:200px; background:#84CC16; opacity:.12; top:55%; left:45%; }

.auth-card { position:relative; z-index:1; background:#fff; width:100%; max-width:430px; border-radius:28px; padding:2.5rem 2.2rem; box-shadow:0 20px 60px rgba(14,116,144,.18); border:3px solid #fff; }
