    ...
    <div class="auth-page bare3" dir="rtl">
        ...
        <div class="auth-shell">
            ...
            <div class="auth-char-wrap">
                ...
                <img src="/images/characters/26.png" alt="شخصية بارع" class="auth-char" />
            </div>
            ...
            <div class="auth-card">
                ...
                <div class="role-chip">
                    <i class="fa-solid fa-user-graduate"></i> بوابة الطالب
                </div>
                ...
                <form @submit.prevent="submit">
                    <div class="field">
                        ...
                        <input type="email" v-model="form.email" required autofocus placeholder="example@bare3.sa" dir="ltr" />
