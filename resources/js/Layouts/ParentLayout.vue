    ...
    <aside class="sidebar" :class="{ collapsed }">
      ...
      <div class="sidebar-footer" v-if="!collapsed">
        <div class="pu-user">
          ...
          <div><div class="pu-name">{{ user?.name }}</div><div class="pu-role">ولي أمر</div></div>
        </div>
...
const initial = computed(() => (user.value?.name?.[0]) ?? 'و')
</script>
...
.sidebar-logo-sm { width: 36px; height: 36px; border-radius: 10px; background: #EC4899; color: white; display: flex; align-items: center; justify-content: center; font-weight: 900; font-size: 1.1rem; }
...
.nav-item.active { background: #EC4899; color: white; }
...
.pu-avatar { width: 36px; height: 36px; border-radius: 50%; background: linear-gradient(135deg, #EC4899, #38BDF8); display: flex; align-items: center; justify-content: center; color: white; font-weight: 800; font-size: .9rem; }
...
.pu-avatar-sm { width: 32px; height: 32px; border-radius: 50%; background: linear-gradient(135deg, #EC4899, #38BDF8); display: flex; align-items: center; justify-content: center; color: white; font-weight: 800; font-size: .8rem; }
